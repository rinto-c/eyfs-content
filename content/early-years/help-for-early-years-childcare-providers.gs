...
* improve outcomes for all children at age 5
* improve outcomes in early language for children from disadvantaged backgrounds
...
What you need to do [ahead of the changes]() will depend on your role and the type of childcare setting you work in. For example, if you work as a childcare practitioner in a nursery, your manager may already be aware of the changes for September 2021.

## Timeline of changes

This acdemic year (20/21) is a transition year where some schools are using the new framework (known as early adopter schools) whilst the rest of the early years providers use the exisiting framework.
...
All other schools and childcare providers should continue to follow the existing early years foundation stage statutory framework until September 2021.
...
[Early Years Foundation Stage early adopter framework](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/896810/EYFS_Early_Adopter_Framework.pdf) This will become the new framework for all childcare providers from September 2021. It is being followed by schools who applied to be early adopters of the new EYFS from September 2020.If you are not from an early adopter school, you may find some elements of this guidance useful, but you will still need to follow the existing EYFS framework until September 2021.
...
The ELGs have been changed to make them clearer and more specific. They are also now more focused on early language and extending vocabulary. Specific changes to the ELGs in the seven areas of learning and development are:
...
### 4. Changes to assessment arrangements (reception year)

The assessment requirements are about when and how you must assess children’s achievements, and when and how you should discuss children’s progress with parents and/or carers.
